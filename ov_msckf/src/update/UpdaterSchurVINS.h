 ...
 */
 ...
 #ifndef OV_MSCKF_UPDATER_SCHURVINS_H
 #define OV_MSCKF_UPDATER_SCHURVINS_H
 ...
 public:
    ...
    */
   UpdaterSchurVINS(UpdaterOptions &options, ov_core::FeatureInitializerOptions &feat_init_options);
 ...
 #endif // OV_MSCKF_UPDATER_SCHURVINS_H
